...
/**
 * Servlet implementation class GetOrdiniByUtente
 */
@WebServlet("/GetOrdiniByUtente")
public class GetOrdiniByUtente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String us= (String) request.getParameter("utentePannello");
		...
		try {
		 	...
		 	listaORD=check.getOrdiniByUser(us);
		 	if(listaORD.isEmpty()) {
