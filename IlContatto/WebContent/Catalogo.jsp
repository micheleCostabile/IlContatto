...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">    
	...
	<div id="tend">
			...
			<h2 id="tendenza">Prodotti di <b id="tendenzab">tendenza</b></h2>
		</div>
		...
		<div class = "col-md-4" id="cardColumn">
       	<form id="ViewForm" method="get" action="ViewProductServlet">
        	<div id="cardProdotti" class="card">
				<div id="picc" >
          			<a href= "ProductView.jsp?codice=<%=p.getCodice()%>"><img id="prodottoPic" src="<%=p.getImmagine()%>" class="card-img-top img-responsive" alt="...">
	          		</a></div>
